...
import { TrendingUp, Users, Lock, ArrowUpRight, X, ChevronDown, Wallet } from 'lucide-react'
...
const chains = [
  ...
  { id: 'arbitrum', name: 'Arbitrum', balance: 0, disabled: false, logo: '/images/arbitrum.svg' },
]
...
const CHAIN_INFO: Record<string, { name: string; bridgeFee: number; isNative: boolean }> = {
  ...
  arbitrum: { name: 'Arbitrum Sepolia', bridgeFee: 1.5, isNative: false },
};
...
export default function PoolsPage() {
  ...
  const currentInvestState = investState
    ...
    <div className="p-6 md:p-8 space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
          <h3 className="font-semibold text-orange-400 mb-2"> Risk Disclaimer</h3>
          <p className="text-sm text-foreground/70">
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div>
                    ...
                    {investAmount && (
                      <div className="mt-3 p-3 bg-blue-500/10 border-blue-500/20 border rounded-lg">
                        <p className="text-sm">
